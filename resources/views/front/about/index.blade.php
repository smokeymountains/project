                ...
                @if ($settings)
                    ...
                    <div class="col-lg-5 mb-1-9 mb-md-2-5 mb-lg-0 wow fadeIn" data-wow-delay="200ms">
                        <div>
                            ...
                            <p class="display-29 display-lg-28 font-weight-400 mb-1-6 mb-lg-2-3">{!! $item->descr1 !!}</p>
                        </div>
                    </div>
                    <div class="col-lg-6 offset-xl-1">
                        <div class="row">
                            <div class="col-6 px-1 wow fadeInUp" data-wow-delay="400ms">
                                <img src="{{ $item->getFirstMediaUrl('about1') }}" class="tilt rounded"
                                    alt="...">
                            </div>
                            <div class="col-6 px-1 wow fadeInUp" data-wow-delay="500ms">
                                <img src="{{ $item->getFirstMediaUrl('about2')  }}" class="tilt rounded"
                                    alt="...">
                            </div>
                        </div>
                    </div>
